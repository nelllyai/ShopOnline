  ...
  wrapper.innerHTML = `
    ...
    <div class="product__info">
      <div class="product__price">
        <p class="product__new-price">${calculations_format(calculations_calculatePriceWithDiscount(price, 1, discount))}</p>
        ${discount > 0 ? `
      ...
      <p class="product__credit">В кредит от ${calculations_format(calculations_calculateCredit(price, 1))}</p>
